...
<body>
    ...
    <div class="row">
        <div id="firstSide" class="container d-flex flex-column  align-items-center side first-side col-5">
            <div class="row d-flex justify-content-end">
                ...
                <div  class="col-auto featured-cat-fighter">
                    <img id = "firstFighterImg" class="featured-cat-fighter-image img-rounded" src="https://via.placeholder.com/300" alt="Featured cat fighter" width="250" height="250">
                </div>
                    ...
                    <div class="row fighter-list">
                        <?php 
                            ...
                            <div class="col-md-4 mb-1">
                                ...
                                <button class="btn btn-primary" id="<?=$row["id"];?>" onclick='edit("<?=$row["id"];?>")'>Edit</button>
                            </div>
                            </div>
                            <?php endwhile; ?>
                            <?php endif; ?>
        ...
        <div id="secondSide" class="container d-flex flex-column align-items-center side second-side col-5">
            <div class="row">
                <div class="col-auto featured-cat-fighter">
                    <img id="secondFighterImg" class="featured-cat-fighter-image img-rounded" src="https://via.placeholder.com/300" alt="Featured cat fighter" width="250" height="250">
                </div>
                <div class="col-auto">
                    <ul class="cat-info list-group">
                        <li class="list-group-item name">Cat Name</li>
    ...
    <div class="text-center">
        <a id="" class="" href="addFighter.html">ADD FIGHTER</a>
    </div>
</body>
</html>
<script>
